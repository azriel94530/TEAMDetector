...
for imageNumber in range(nImagesPerFile):
  ...
  RawImageTH2Ds.append(PythonTools_ROOT.MakeTH2DObject(nPixelsX, nPixelsY, lPixelX, lPixelY))
...
MedianDarkImage = PythonTools_ROOT.MakeTH2DObject(nPixelsX, nPixelsY, lPixelX, lPixelY)
...
for imageNumber in range(nImagesPerFile):
  ...
  DCImageTH2Ds.append(PythonTools_ROOT.MakeTH2DObject(nPixelsX, nPixelsY, lPixelX, lPixelY))
...
for imageNumber in range(nImagesPerFile):
  ...
  Sum01Spectra.append(PythonTools_ROOT.MakePixValHisto("Sum01Spectra" + str(imageNumber), "Sum(1) Spectrum for TEAM Detector at Time Stamp: " + str(int(RawImageTH2Ds[imageNumber].GetBinContent(1, 0))), nBins, xLo, xHi, ROOT.kRed))
  Sum09Spectra.append(PythonTools_ROOT.MakePixValHisto("Sum09Spectra" + str(imageNumber), "Sum(9) Spectrum for TEAM Detector at Time Stamp: " + str(int(RawImageTH2Ds[imageNumber].GetBinContent(1, 0))), nBins, xLo, xHi, ROOT.kBlue))
  Sum25Spectra.append(PythonTools_ROOT.MakePixValHisto("Sum25Spectra" + str(imageNumber), "Sum(25) Spectrum for TEAM Detector at Time Stamp: " + str(int(RawImageTH2Ds[imageNumber].GetBinContent(1, 0))), nBins, xLo, xHi, ROOT.kBlack))
...
SummedSum01Spectrum = PythonTools_ROOT.MakePixValHisto("SummedSum01Spectrum", "Sum(1)  Spectrum for TEAM Detector Summed Over All Frames in " + InputFilePath, nBins, xLo, xHi, ROOT.kRed)
SummedSum09Spectrum = PythonTools_ROOT.MakePixValHisto("SummedSum09Spectrum", "Sum(9)  Spectrum for TEAM Detector Summed Over All Frames in " + InputFilePath, nBins, xLo, xHi, ROOT.kBlue)
SummedSum25Spectrum = PythonTools_ROOT.MakePixValHisto("SummedSum25Spectrum", "Sum(25) Spectrum for TEAM Detector Summed Over All Frames in " + InputFilePath, nBins, xLo, xHi, ROOT.kBlack)
